    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-purple-50 to-blue-50 py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <Card className="border-0 bg-white shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
              <CardContent className="p-6">
                <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 transition-transform hover:scale-110">
                  <Award className="h-7 w-7 text-white" />
                </div>
                <h3 className="mb-2 text-xl font-bold text-gray-900">Lab Certified</h3>
            ...
            <Card className="border-0 bg-white shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
              <CardContent className="p-6">
                <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-600 transition-transform hover:scale-110">
                  <Leaf className="h-7 w-7 text-white" />
                </div>
                <h3 className="mb-2 text-xl font-bold text-gray-900">Ethical Sourcing</h3>
                <p className="text-sm leading-relaxed text-gray-600">
            ...
            <Card className="border-0 bg-white shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
              <CardContent className="p-6">
                <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-orange-500 to-orange-600 transition-transform hover:scale-110">
                  <Tag className="h-7 w-7 text-white" />
                </div>
                <h3 className="mb-2 text-xl font-bold text-gray-900">Transparent Pricing</h3>
                <p className="text-sm leading-relaxed text-gray-600">
            ...
            <Card className="border-0 bg-white shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
              <CardContent className="p-6">
                <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-purple-500 to-purple-600 transition-transform hover:scale-110">
                  <Globe2 className="h-7 w-7 text-white" />
                </div>
                <h3 className="mb-2 text-xl font-bold text-gray-900">Worldwide Delivery</h3>
                <p className="text-sm leading-relaxed text-gray-600">
          ...
          {/* Statistics Banner */}
          <div className="mt-12 overflow-hidden rounded-2xl bg-gradient-to-r from-blue-600 via-purple-600 to-purple-700 p-8 shadow-xl relative">
            <div className="absolute inset-0 animate-shimmer" />
            <div className="relative grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
              <div className="text-center text-white">
                <div className="mb-2 font-serif text-4xl font-bold">20+</div>
                <div className="text-sm text-white/90">Years Experience</div>
              </div>
              <div className="text-center text-white">
                <div className="mb-2 font-serif text-4xl font-bold">100%</div>
                <div className="text-sm text-white/90">Certified Gems</div>
              </div>
              <div className="text-center text-white">
                <div className="mb-2 font-serif text-4xl font-bold">50+</div>
                <div className="text-sm text-white/90">Countries Served</div>
              </div>
              <div className="text-center text-white">
                <div className="mb-2 font-serif text-4xl font-bold">5000+</div>
      ...
      {/* CTA Section - Dark Blue with Enhanced Design */}
      <section className="relative overflow-hidden bg-gradient-to-br from-[#1e3a8a] via-[#1e40af] to-[#2563eb] py-24">
        <div
          className="absolute inset-0 opacity-5"
          style={{
            backgroundImage: "url(/placeholder.svg?height=1080&width=1920&query=gemstones+scattered+pattern)",
            backgroundSize: "cover",
            backgroundPosition: "center",
          }}
        />
        <div className="container relative mx-auto px-4 text-center sm:px-6 lg:px-8">
          <div className="mx-auto mb-8 flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-amber-400 via-emerald-500 to-emerald-600 shadow-2xl animate-scale-in">
            <Mail className="h-12 w-12 text-white" />
          </div>

          <h2
            className="mb-6 font-serif text-4xl font-bold tracking-tight text-balance text-white sm:text-5xl lg:text-6xl animate-fade-in-up"
            style={{ animationDelay: "0.1s", animationFillMode: "both" }}
          >
            Ready to Discover Your Perfect Gemstone?
          </h2>
          <p
            className="mx-auto mb-10 max-w-3xl text-xl leading-relaxed text-white/90 text-pretty animate-fade-in-up"
            style={{ animationDelay: "0.1s", animationFillMode: "both" }}
          >
          ...
          <div
            className="mb-10 flex flex-wrap justify-center gap-4 animate-fade-in-up"
            style={{ animationDelay: "0.2s", animationFillMode: "both" }}
          >
            <Button
              size="lg"
              className="h-14 gap-2 rounded-xl bg-amber-500 px-8 text-base font-semibold text-black shadow-xl hover:bg-amber-600 transition-all hover:scale-105 hover:shadow-2xl"
              asChild
            >
              <Link href="/shop">
                <Gem className="h-5 w-5" />
            ...
            <Button
              size="lg"
              variant="outline"
              className="h-14 gap-2 rounded-xl border-2 border-white/30 bg-white px-8 text-base font-semibold text-blue-900 shadow-xl hover:bg-white/90 transition-all hover:scale-105"
              asChild
            >
              <Link href="/contact">
                <MessageCircle className="h-5 w-5" />
          ...
          >
            <Button
              variant="ghost"
              className="h-12 gap-3 rounded-xl border border-white/10 bg-[#1e293b]/80 px-6 text-white backdrop-blur-sm hover:bg-[#1e293b] transition-all hover:scale-105"
              asChild
            >
          ...
          <div
            ...
            style={{ animationDelay: "0.4s", animationFillMode: "both" }}
          >
            <div className="flex items-center gap-3 rounded-full border border-white/10 bg-[#1e293b]/60 px-6 py-3 backdrop-blur-sm transition-transform hover:scale-105">
