...
export default function ShopPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="mt-20 border-b border-border bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 py-20 animate-fade-in">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="animate-fade-in-up">
            <Badge className="mb-6 border-blue-600 bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg transition-transform hover:scale-105">
              Premium Collection
            </Badge>
            <h1 className="mb-6 font-serif text-5xl font-bold tracking-tight sm:text-6xl bg-gradient-to-r from-blue-900 via-purple-900 to-pink-900 bg-clip-text text-transparent">
              Shop Gemstones
            </h1>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={priceRange} onValueChange={setPriceRange}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="300k-750k">300K - 750K</SelectItem>
                      <SelectItem value="750k-1200k">750K - 1.2M</SelectItem>
                      <SelectItem value="over-1200k">Over 1.2M</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: "0.2s", animationFillMode: "both" }}>
            ...
            {filteredGemstones.length === 0 && (
              <div className="flex flex-col items-center justify-center rounded-xl bg-gray-50 py-16 text-center animate-scale-in">
